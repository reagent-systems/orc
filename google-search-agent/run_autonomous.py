#!/usr/bin/env python3
"""
Autonomous SearchAgent Runner

This script starts the SearchAgent in autonomous mode, monitoring the workspace
for search-related tasks to claim and process.
"""
...
# Add the search_agent module to the path
...
async def main():
    """Main entry point for autonomous SearchAgent"""
    print("🚀 Starting SearchAgent in autonomous mode...")
    print("=" * 50)
    ...
    try:
        await search_agent.monitor_workspace()
    except KeyboardInterrupt:
        print("\n⏹️  SearchAgent shutting down...")
