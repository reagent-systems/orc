#!/usr/bin/env python3
"""
Autonomous TaskBreakdownAgent Runner

This script starts the TaskBreakdownAgent in autonomous mode, monitoring the workspace
for complex tasks that need decomposition and orchestration.
"""
...
# Add the task_breakdown_agent module to the path
sys.path.insert(0, str(Path(__file__).parent))

from task_breakdown_agent.agent import task_breakdown_agent
...
async def main():
    """Main entry point for autonomous TaskBreakdownAgent"""
    print("🤖 Starting TaskBreakdownAgent in autonomous mode...")
    print("=" * 50)
    ...
    try:
        ...
        print("\n⏹️  TaskBreakdownAgent shutting down...")
