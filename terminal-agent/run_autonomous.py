#!/usr/bin/env python3
"""
Autonomous TerminalAgent Runner

This script starts the TerminalAgent in autonomous mode, monitoring the workspace
for command execution and system operation tasks to claim and process.
"""
...
# Add the terminal_agent module to the path
sys.path.insert(0, str(Path(__file__).parent))

from terminal_agent.agent import terminal_agent
...
async def main():
    """Main entry point for autonomous TerminalAgent"""
    print("🤖 Starting TerminalAgent in autonomous mode...")
    print("=" * 50)
...
if __name__ == "__main__":
    ...
    # Check if running on macOS and suggest xcode tools if needed
    if sys.platform == 'darwin':
        print("💡 Running on macOS - ensure Xcode command line tools are installed:")
